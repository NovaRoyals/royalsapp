...
const mensOpenMatches: ScheduleEvent[] = [
  {
    ...
    type: 'league_match',
    sport: 'soccer',
    title: 'Nova Royals AC (Open) vs rundown fc',
  ...
  },
  {
    ...
    type: 'league_match',
    sport: 'soccer',
    title: 'Nova Royals AC (Open) vs Fades FC',
  ...
  },
  {
    ...
    type: 'league_match',
    sport: 'soccer',
    title: 'Nova Royals AC (Open) vs Ref Do Something FC',
    subtitle: 'Home · Men’s Open 8v8',
...
const veterans35Matches: ScheduleEvent[] = fxa35PlusMatches.map((match) => ({
  ...
  title: `Nova Royals AC (35+) vs ${match.opponentName}`,
...
export const demoAnnouncements: Announcement[] = [
  {
    id: 'announcement-1',
    title: 'Fall training is underway',
    body: 'Kids train Sundays 9:00–10:00 AM at Arrowhead Park Field 3A. Women’s practice is 8:00–8:30 AM on the same pitch.',
    audience: 'club',
  ...
  },
  {
    ...
    body: 'Nova Royals AC (Open) vs Fades FC · 10:00 PM · Nottoway Park Field 4A. Submit your RSVP so the squad knows who is checking in.',
    audience: 'team',
...
export const demoNotifications: AppNotification[] = [
  {
    id: 'notification-1',
    type: 'reminder',
    title: 'Next Sunday: Fall Soccer Training',
    body: 'Maya’s next session is Sep 27 at 9:00 AM at Arrowhead Park Field 3A.',
    createdAt: '2026-09-20T11:00:00-04:00',
    read: false,
    route: '/event/kids-2026-09-27',
    urgency: 'normal',
    wouldPush: true,
  },
  {
